    ...
    <div class="container">
      ...
      <div v-show="!err2005" class="">
        ...
        <div v-else class="registerBox">
          ...
          <el-input type="text" placeholder="昵称" v-model="nnickName"> </el-input>
...
export default {
  ...
  methods: {
    ...
    routeChange: function () {
      var that = this;
      that.login =
        that.$route.query.login == undefined ? 1 : parseInt(that.$route.query.login); //获取传参的login
      that.urlstate =
    ...
    newRegister: function () {
      ...
      if (!that.nusernameErr && !that.nemailErr && !that.npasswordErr) {
        ...
        userRegister(that.nusername, that.nnickName, that.nemail, that.npassword)
          .then((response) => {
            //注册成功后调整到登录
            that.goLogin();
          })
